...
const DisciplineInputsItem = (props) => {
  const { data, refetch, setIsError } = props;
  ...
  return (
    <div className="inputs__item">
      <input
        className="inputs-item__input"
        value={data.diciplineName}
        disabled
      />
...
export default DisciplineInputsItem;
